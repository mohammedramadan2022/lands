<!--begin::Form-->
<form id="form" enctype="multipart/form-data" method="POST" action="{{ route('members.store') }}">
    @csrf
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <select class="form-control" id="role" name="role">
                ...
                <option value="manager">مدير اللجنه</option>
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                <span class="required mr-1">كلمة المرور<span class="red-star">*</span></span>
            </label>
            <input required type="password" class="form-control form-control-solid" placeholder="" name="password"/>
        </div>
